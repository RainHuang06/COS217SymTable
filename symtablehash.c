...
/*Defines the table*/
struct SymTable {
    /*Size of table - how many entries*/
    size_t length; 
    /*Size of expansion*/
    size_t curExpansionLength;
    /*Stores first linked list node*/
    struct Entry** contents; 
};

const size_t sizeBuckets[] = {509, 1021, 2039, 4093, 8191, 16381, 32749, 65521};
...
SymTable_T SymTable_new() {
    ...
    newSymTable->curExpansionLength = 0;
    newSymTable->contents = calloc(sizeBuckets[newSymTable->curExpansionLength], sizeof(struct Entry*));
    return newSymTable;
}
